...
Hotkey  !^n,	Mine			; Pressing ctrl + alt + n will start mining
...
MenuMining:
{
	...
	Gui, Add, Text,, Windows HWIND is : %id%
	Gui, Add, Text,, CURRENT AVALIBLE OPTIONS: 
	Gui, Add, Text,, o- Pressing ctrl + alt + n will begin mining operation
	Gui, Add, Text,, o- Pressing ctrl + alt + s will stop any AutoKey funtion above
	Gui, Show,, Minecraft X-AHK V0.4
...
;===================================================================================================
; Called when Ctrl+Alt+N is pressed and continuly holds LEFT mouse key
Mine:
{
	if (ProgState != 5)
		Return
	...
	BreakLoop := 0
		Loop
		{
			...
			Sleep 100
				ControlClick, , ahk_id %id%, ,Left, , NAD
			Sleep 7500		; Based on the amount of time it takes to break cobblestone with a stone pickaxe
				ControlClick, , ahk_id %id%, ,Left, , NAU
		}
	Return
}
